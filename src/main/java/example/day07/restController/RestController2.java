...
public class RestController2 {
    ...
    @ResponseBody   // 응답할 데이터의 자바 타입을 HTTP 타입으로 자동 설정 : (JAVA)String -> (HTTP)text/plain;
    ...
    @ResponseBody   // 응답할 데이터의 자바 타입을 HTTP 타입으로 자동 설정 : (JAVA)String -> (HTTP)application/json
    public ArrayList<RestDto> postRest2(HttpServletRequest request){
        System.out.println("RestController2.postRest2");
        // 1. 요청
        String key = request.getParameter("key");
        System.out.println("key = " + key);
        // 2. 응답
